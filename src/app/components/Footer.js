    ...
    return (
      <footer className="bg-stone-700 text-white text-center py-6 w-full mt-10">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-sm mb-2">Fan created, non-profit. Not associated with Survivor/Paramount/CBS</p>
          <p className="text-sm mb-2">Entered data (images, names, etc.) is only ever stored locally</p>
          <button 
